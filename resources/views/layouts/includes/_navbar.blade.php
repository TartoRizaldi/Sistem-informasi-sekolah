<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.html"><img src="{{asset('admin/logo-smk.png')}}" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="/profilsaya"><i class="lnr lnr-user"></i> <span>Profile Saya</span></a></li>
