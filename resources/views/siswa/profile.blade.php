					...
					<table class="table table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="/siswa/{{$siswa->id}}/{{$mapel->id}}/deletenilai" class="btn btn-danger btn-sm" onclick="return confirm('Konfirmasi menghapus data')">Delete</a></td>
							</tr>
							</tr>
							@endforeach
						</tbody>
		      ...
		      <div class="modal-body">
			    ...
			    <select class="form-control" id="mapel" name="mapel">
				  ...
				  <div class="form-group{{$errors->has('nilai') ? ' has-error' : ''}}">
				    ...
				    <input name="nilai" input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nilai" value="{{old('nilai')}}">
				    @if($errors->has('nilai'))
